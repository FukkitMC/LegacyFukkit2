...
public class CursedOptionLoader {
    public static boolean useJline = true;
    public static boolean useConsole = true;

    public static OptionSet bukkitOptions = null;
    ...
    public static OptionSet loadOptions(String[] args) {
        ...
        try {
            ...
            Logger.getLogger(CursedOptionLoader.class.getName()).log(Level.SEVERE, ex.getLocalizedMessage());
        }
        ...
        if ((options == null) || (options.has("?"))) {
            try {
                ...
                Logger.getLogger(CursedOptionLoader.class.getName()).log(Level.SEVERE, null, ex);
            }
